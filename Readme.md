...
5. Click **Add**, then find **Home Organizer Ultimate** in the list and click **Download**.  
...
3. Search for **Home Organizer Ultimate**.  
...
1. Click the **Pencil (Edit)** icon to reveal the **Add Panel** at the bottom of the screen.
