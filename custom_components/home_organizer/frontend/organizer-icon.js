...
export const ICON_LIB_ITEM = {
  ...
  "Shoes": '<svg viewBox="0 0 24 24"><path d="M21 15h-3V9l-8 4-6-1v6h17zM4 13l6 1 8-4v5H4z"/></svg>',
  "Socks": '<svg viewBox="0 0 24 24"><path d="M16 3h-4v10l-4 3 2 5h6zM13 5h2v7l-3 2 1 3h3V5z"/></svg>',
  "Jacket": '<svg viewBox="0 0 24 24"><path d="M12 2l-8 3v15h16V5l-8-3zM6 6v12h12V6l-6-2z"/></svg>',
  "Hat": '<svg viewBox="0 0 24 24"><path d="M12 4c-4 0-5 3-5 5h10c0-2-1-5-5-5zM2 15h20v2H2z"/></svg>',
  "Belt": '<svg viewBox="0 0 24 24"><path d="M2 10h20v4H2zm8-1h4v6h-4v-6z"/></svg>',
  "Scarf": '<svg viewBox="0 0 24 24"><path d="M6 4h12v4H6zm10 4v12h2V8zm-8 0v10l2 2V8z"/></svg>',
  "Gloves": '<svg viewBox="0 0 24 24"><path d="M7 8h2v4H7zm4-2h2v6h-2zm4 2h2v4h-2zm-10 6h14v4l-2 2H7l-2-2z"/></svg>',
  "Sneakers": '<svg viewBox="0 0 24 24"><path d="M3 18h18v2H3zM5 10l5 2 10-4v10H5z"/></svg>',
  "Boots": '<svg viewBox="0 0 24 24"><path d="M7 4h5v12l6 2v2H5V4z"/></svg>',
  "Tie": '<svg viewBox="0 0 24 24"><path d="M10 2h4l2 3-3 15-3 2-3-2-3-15z"/></svg>',
  "Skirt": '<svg viewBox="0 0 24 24"><path d="M8 2h8l4 18H4L8 2z"/></svg>',
  "Suit": '<svg viewBox="0 0 24 24"><path d="M12 2l-8 3v15h16V5l-8-3zm0 2l6 2.25V18H6V6.25L12 4z"/></svg>',
  "Sandals": '<svg viewBox="0 0 24 24"><path d="M21 18H3v2h18v-2zM5 12l5 2 9-5v6H5z"/></svg>',
  "Shorts": '<svg viewBox="0 0 24 24"><path d="M4 2h16v14l-4 0 0 4-4-2-4 2 0-4-4 0z"/></svg>',
  "Bra": '<svg viewBox="0 0 24 24"><path d="M12 14c-4 0-6-3-6-3l-2 0 0 5h16v-5l-2 0s-2 3-6 3z"/></svg>',
  "Underwear": '<svg viewBox="0 0 24 24"><path d="M2 4h20l-10 16z"/></svg>',
  "Pajamas": '<svg viewBox="0 0 24 24"><path d="M12 2l-8 3v15h6v-6h4v6h6V5l-8-3z"/></svg>',
  "Vest": '<svg viewBox="0 0 24 24"><path d="M12 2l-8 3v15h16V5l-8-3zM7 6l5 2 5-2v12H7V6z"/></svg>',
  "Cap": '<svg viewBox="0 0 24 24"><path d="M12 4a8 8 0 0 0-8 8h16a8 8 0 0 0-8-8zM2 12h20l-2 4H4z"/></svg>',
  "Glove": '<svg viewBox="0 0 24 24"><path d="M19 10a3 3 0 0 0-6 0h-2a3 3 0 0 0-6 0v10h14z"/></svg>',
  ...
  "Tomato": '<svg viewBox="0 0 24 24"><circle cx="12" cy="13" r="8" fill="none" stroke="currentColor" stroke-width="2"/></svg>',
  "Potato": '<svg viewBox="0 0 24 24"><ellipse cx="12" cy="12" rx="9" ry="6" fill="none" stroke="currentColor" stroke-width="2"/></svg>',
  "Broccoli": '<svg viewBox="0 0 24 24"><path d="M12 10c3 0 5-2 5-5s-2-3-5-3-5 0-5 3 2 5 5 5zM10 10h4v10h-4z"/></svg>',
  "Onion": '<svg viewBox="0 0 24 24"><path d="M12 20c-4 0-7-3-7-7s3-10 7-11 7 7 7 11-3 7-7 7z"/></svg>',
  "Garlic": '<svg viewBox="0 0 24 24"><path d="M12 20c-4 0-6-4-6-8s2-8 6-8 6 4 6 8-2 8-6 8z"/></svg>',
  "Lettuce": '<svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="9" fill="none" stroke="currentColor" stroke-width="2"/></svg>',
  "Pepper": '<svg viewBox="0 0 24 24"><path d="M12 21c-4 0-6-3-6-9s2-9 6-9 6 3 6 9-2 9-6 9z"/></svg>',
  "Corn": '<svg viewBox="0 0 24 24"><path d="M12 2c-3 0-4 4-4 10s1 10 4 10 4-4 4-10-1-10-4-10z"/></svg>',
  "Lemon": '<svg viewBox="0 0 24 24"><ellipse cx="12" cy="12" rx="9" ry="6" fill="none" stroke="currentColor" stroke-width="2"/></svg>',
  "Grapes": '<svg viewBox="0 0 24 24"><circle cx="10" cy="10" r="3"/><circle cx="14" cy="10" r="3"/><circle cx="12" cy="14" r="3"/></svg>',
  "Strawberry": '<svg viewBox="0 0 24 24"><path d="M12 21c-4 0-5-8-5-12s1-5 5-5 5 1 5 5-1 12-5 12z"/></svg>',
  "Pear": '<svg viewBox="0 0 24 24"><path d="M12 2c-3 0-4 4-4 6 0 5 4 14 4 14s4-9 4-14c0-2-1-6-4-6z"/></svg>',
  "Orange": '<svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="9" fill="none" stroke="currentColor" stroke-width="2"/></svg>',
  "Kiwi": '<svg viewBox="0 0 24 24"><ellipse cx="12" cy="12" rx="8" ry="6" fill="none" stroke="currentColor" stroke-width="2"/></svg>',
  "Melon": '<svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" fill="none" stroke="currentColor" stroke-width="2"/></svg>',
  "Zucchini": '<svg viewBox="0 0 24 24"><path d="M3 18l18-12" stroke="currentColor" stroke-width="3"/></svg>',
  "Cucumber": '<svg viewBox="0 0 24 24"><path d="M3 18l18-12" stroke="currentColor" stroke-width="2"/></svg>',
  "Mushroom": '<svg viewBox="0 0 24 24"><path d="M4 12a8 8 0 0 1 16 0zM10 12h4v8h-4z"/></svg>',
  "Avocado": '<svg viewBox="0 0 24 24"><path d="M12 2c-4 0-6 6-6 10s2 10 6 10 6-6 6-10-2-10-6-10zm0 16c-2 0-3-2-3-4s1-4 3-4 3 2 3 4-1 4-3 4z"/></svg>',
  "Pineapple": '<svg viewBox="0 0 24 24"><path d="M12 22c-3 0-5-4-5-9s2-9 5-9 5 4 5 9-2 9-5 9zM10 4h4v4h-4z"/></svg>',
  ...
  "Pasta": '<svg viewBox="0 0 24 24"><path d="M19 6h-3c0-2.21-1.79-4-4-4S8 3.79 8 6H5c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2z"/></svg>',
  "Rice": '<svg viewBox="0 0 24 24"><path d="M19 6h-3c0-2.21-1.79-4-4-4S8 3.79 8 6H5c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2z"/></svg>',
  "Sugar": '<svg viewBox="0 0 24 24"><path d="M19 6h-3c0-2.21-1.79-4-4-4S8 3.79 8 6H5c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2z"/></svg>',
  "Salt": '<svg viewBox="0 0 24 24"><path d="M18 4h-1V2h-2v2H9V2H7v2H6c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2z"/></svg>',
  "Coffee": '<svg viewBox="0 0 24 24"><path d="M18.5 3H6c-1.1 0-2 .9-2 2v5.71c0 3.83 2.95 7.18 6.78 7.29 3.96.12 7.22-3.06 7.22-7v-1h.5c1.93 0 3.5-1.57 3.5-3.5S20.43 3 18.5 3z"/></svg>',
  "Tea": '<svg viewBox="0 0 24 24"><path d="M18.5 3H6c-1.1 0-2 .9-2 2v5.71c0 3.83 2.95 7.18 6.78 7.29 3.96.12 7.22-3.06 7.22-7v-1h.5c1.93 0 3.5-1.57 3.5-3.5S20.43 3 18.5 3z"/></svg>',
  "Oil": '<svg viewBox="0 0 24 24"><path d="M18 4h-1V2h-2v2H9V2H7v2H6c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2z"/></svg>',
  "Flour": '<svg viewBox="0 0 24 24"><path d="M19 6h-3c0-2.21-1.79-4-4-4S8 3.79 8 6H5c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2z"/></svg>',
  "Honey": '<svg viewBox="0 0 24 24"><path d="M18 4h-1V2h-2v2H9V2H7v2H6c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2z"/></svg>',
  "Jam": '<svg viewBox="0 0 24 24"><path d="M18 4h-1V2h-2v2H9V2H7v2H6c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2z"/></svg>',
  "Butter": '<svg viewBox="0 0 24 24"><path d="M21 4H3c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2z"/></svg>',
  "Yogurt": '<svg viewBox="0 0 24 24"><path d="M18 4h-1V2h-2v2H9V2H7v2H6c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2z"/></svg>',
  "Cereal": '<svg viewBox="0 0 24 24"><path d="M19 6h-3c0-2.21-1.79-4-4-4S8 3.79 8 6H5c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2z"/></svg>',
  "Wine": '<svg viewBox="0 0 24 24"><path d="M6 3v6c0 2.97 2.16 5.43 5 5.91V19H8v2h8v-2h-3v-4.09c2.84-.48 5-2.94 5-5.91V3H6z"/></svg>',
  "Beer": '<svg viewBox="0 0 24 24"><path d="M18 4h-1V2h-2v2H9V2H7v2H6c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2z"/></svg>',
  "Soda": '<svg viewBox="0 0 24 24"><path d="M18 4h-1V2h-2v2H9V2H7v2H6c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2z"/></svg>',
  "Juice": '<svg viewBox="0 0 24 24"><path d="M18 4h-1V2h-2v2H9V2H7v2H6c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2z"/></svg>',
  "Canned Food": '<svg viewBox="0 0 24 24"><path d="M18 4h-1V2h-2v2H9V2H7v2H6c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2z"/></svg>',
  "Snacks": '<svg viewBox="0 0 24 24"><path d="M19 6h-3c0-2.21-1.79-4-4-4S8 3.79 8 6H5c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2z"/></svg>',
  ...
  "Tape": '<svg viewBox="0 0 24 24"><path d="M12 2C9.24 2 7 4.24 7 7v10H4v4h16v-4h-3V7c0-2.76-2.24-5-5-5z"/></svg>',
  ...
  "Toothpaste": '<svg viewBox="0 0 24 24"><path d="M17 2H7c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z"/></svg>',
  "Towel": '<svg viewBox="0 0 24 24"><path d="M19 6h-3c0-2.21-1.79-4-4-4S8 3.79 8 6H5c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2z"/></svg>',
  "Toilet Paper": '<svg viewBox="0 0 24 24"><path d="M18 4h-1V2h-2v2H9V2H7v2H6c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2z"/></svg>',
  "Laundry Detergent": '<svg viewBox="0 0 24 24"><path d="M18 4h-1V2h-2v2H9V2H7v2H6c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2z"/></svg>',
  "Broom": '<svg viewBox="0 0 24 24"><path d="M12 2C9.24 2 7 4.24 7 7v10H4v4h16v-4h-3V7c0-2.76-2.24-5-5-5z"/></svg>',
  "Mop": '<svg viewBox="0 0 24 24"><path d="M12 2C9.24 2 7 4.24 7 7v10H4v4h16v-4h-3V7c0-2.76-2.24-5-5-5z"/></svg>',
  "Bucket": '<svg viewBox="0 0 24 24"><path d="M20 2H4c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z"/></svg>',
  "Vacuum": '<svg viewBox="0 0 24 24"><path d="M20 2H4c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z"/></svg>',
  "Iron": '<svg viewBox="0 0 24 24"><path d="M20 2H4c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z"/></svg>',
  ...
  "Seeds": '<svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="2"/></svg>',
