...
export const ICONS = {
  ...
  robot: '<svg viewBox="0 0 24 24"><path d="M21.92 15.62a2.49 2.49 0 0 0-.15-1.09l-1.5-3.56c-.36-.85-1.19-1.39-2.11-1.39h-.33l-.9-4.75a2.5 2.5 0 0 0-2.5-2.03H9.57a2.5 2.5 0 0 0-2.5 2.03l-.9 4.75h-.33c-.92 0-1.75.54-2.11 1.39L2.23 14.53a2.5 2.5 0 0 0-.15 1.09c0 1.03.62 1.9 1.53 2.29.07 2.14 1.67 3.91 3.76 4.34L7.04 24h9.92l-.33-1.75c2.09-.43 3.69-2.2 3.76-4.34.91-.39 1.53-1.26 1.53-2.29zM12 2c.83 0 1.5.67 1.5 1.5S12.83 5 12 5s-1.5-.67-1.5-1.5S11.17 2 12 2zM9 13.5c.83 0 1.5.67 1.5 1.5s-.67 1.5-1.5 1.5-1.5-.67-1.5-1.5.67-1.5 1.5-1.5zm6 0c.83 0 1.5.67 1.5 1.5s-.67 1.5-1.5 1.5-1.5-.67-1.5-1.5.67-1.5 1.5-1.5z"/></svg>',
...
// ... (Rest of ICON_LIB and ICON_LIB_ITEM - kept identical to previous version)
