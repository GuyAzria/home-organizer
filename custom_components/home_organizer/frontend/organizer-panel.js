// Home Organizer Ultimate - ver 2.1.1
...
class HomeOrganizerPanel extends HTMLElement {
  ...
  updateUI() {
    ...
    root.getElementById('display-path').innerText = attrs.app_version || '2.1.1';
