...
import { ICONS, ICON_LIB, ICON_LIB_ROOM, ICON_LIB_LOCATION, ICON_LIB_ITEM } from './organizer-icon.js?v=10.8.6';
import { UtilsMixin }  from './organizer-utils.js?v=10.8.6';
import { StateMixin }  from './organizer-state.js?v=10.8.6';
import { APIMixin }    from './organizer-api.js?v=10.8.6';
import { CameraMixin } from './organizer-camera.js?v=10.8.6';
import { NavMixin }    from './organizer-nav.js?v=10.8.6';
import { IconsMixin }  from './organizer-icons.js?v=10.8.6';
import { UIMixin }     from './organizer-ui.js?v=10.8.6';

import { StylistMixin }   from './pages/view-stylist.js?v=10.8.6';
import { BarcodeMixin }   from './pages/view-barcode.js?v=10.8.6';
import { InventoryMixin } from './pages/view-inventory.js?v=10.8.6';
import { ChatMixin }      from './pages/view-chat.js?v=10.8.6';
import { ShoppingMixin }  from './pages/view-shopping.js?v=10.8.6';
import { SearchMixin }    from './pages/view-search.js?v=10.8.6';
