// Home Organizer Ultimate - Ver 4.3.0 (Delete Sublocation Fix & Icons)
// License: MIT
    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        * { box-sizing: border-box; }
        ...
        .edit-subloc-btn:hover { color: var(--primary); background: rgba(255,255,255,0.1); border-radius: 4px; }
        ...
        .delete-subloc-btn:hover { background: rgba(244, 67, 54, 0.1); border-radius: 4px; }
