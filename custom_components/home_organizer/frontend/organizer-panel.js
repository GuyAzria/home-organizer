// Home Organizer Ultimate - Ver 5.6.4 (Category Navigation Update)
// License: MIT
...
      this.pickerCategory = null; // Tracks current item category
      this.pickerPage = 0;
...
              
              // Find a sample icon for the category button if available
